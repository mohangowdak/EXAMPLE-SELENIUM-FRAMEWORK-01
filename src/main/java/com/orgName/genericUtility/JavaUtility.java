...
public class JavaUtility {
	...
	public   long stringToLong(String value) {
		...
		GetterandSetterForUtility.getTest().info("String data Changed to Long DataType");
		return longData;
	}
	...
	public   int getRandomNumber(int limit) {
		 ...
		 GetterandSetterForUtility.getTest().info("Random Number Generated Successfully");
		return ran;
	}
	...
	public   String getDateTimeInFormat() {
		...
		GetterandSetterForUtility.getTest().info("Current Date is Fetched SuccessFully");
		return currentDate;
	}
}
