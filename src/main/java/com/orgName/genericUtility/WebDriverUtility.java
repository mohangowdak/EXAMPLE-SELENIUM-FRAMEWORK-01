...
public final class WebDriverUtility {
	...
	public void launchBrowser(String browser) {
		...
		case "chrome":
			...
			GetterandSetterForUtility.setDriver(new ChromeDriver(options));
			GetterandSetterForUtility.getTest().info("Chrome Driver Launced SuccessFully");
			break;
		case "firefox":
			GetterandSetterForUtility.setDriver(WebDriverManager.firefoxdriver().create());
			GetterandSetterForUtility.getTest().info("FireFox Driver Launced SuccessFully");
			break;
		case "edge":
			GetterandSetterForUtility.setDriver(WebDriverManager.edgedriver().create());
			GetterandSetterForUtility.getTest().info("Edge Driver Launced SuccessFully");
			break;
		case "ie":
			GetterandSetterForUtility.getTest().info("Internet Explorer Driver Launced SuccessFully");
			GetterandSetterForUtility.setDriver(WebDriverManager.iedriver().create());
			break;
		default:
			GetterandSetterForUtility.getTest().info("please specify proper browser key");
			WebDriverManager.chromedriver().setup();
			GetterandSetterForUtility.getTest().info("Chrome Driver Launced SuccessFully");
			GetterandSetterForUtility.setDriver(new ChromeDriver(options));
			break;
		}
		driver=GetterandSetterForUtility.getDriver();
	}
	...
	public  void navigateApp(String url) {
		driver.get(url);
		GetterandSetterForUtility.getTest().info("Application Navigated SuccessFully");
	}
	...
	public  String getTitle() {
		...
		GetterandSetterForUtility.getTest().info("Title of the WebPage SuccessFully");
		return title;
	}
	...
	public void maximizeBrowser() {
		...
		GetterandSetterForUtility.getTest().info("Browser Maximized Successfully");
	}
	...
	public  void waitTillPageLoad(long longTimeOut) {
		...
		GetterandSetterForUtility.getTest().info("Implicit wait Applied");
	}
	...
	public  void intiallizeActions(WebDriver driver) {
		...
		GetterandSetterForUtility.getTest().info("Actions class intiallized");
	}
	...
	public  void mouseHoverOntheElement(WebElement moreLink) {
		...
		GetterandSetterForUtility.getTest().info("Mouse Hover Action is Performed on the Element");
	}
	...
	public  void doubleClick(WebElement moreLink) {
		...
		GetterandSetterForUtility.getTest().info("Double Click Action is Performed Succefully");
	}
	...
	public void quitBrowser() {
		driver.quit();
		GetterandSetterForUtility.getTest().info("Browser Closed Succefully");
	}
	...
	public  void waitUntillElementClickable(WebElement element) {
		...
		GetterandSetterForUtility.getTest().info("Controller waiting till the element to be clickable");
	}
	...
	public  void waitUntillElementVisible( WebElement element) {
		...
		GetterandSetterForUtility.getTest().info("Controller waiting till the element visible");
	}
	...
	public  void explicitlyWait(long timeOut) {
		...
		GetterandSetterForUtility.getTest().info("Explicit wait is intiallized");
	}
	...
	public  void switchToWindowBasedOnTitle(String partialText) {
		...
		for(String id:sessionIDs)
		{
			...
			{
				GetterandSetterForUtility.getTest().info("Window Switched Successfully Based on title");
				break;
			}
	...
	public  void selectDropDown(WebElement element, String value) {
		...
		GetterandSetterForUtility.getTest().info("Dropdown selected based on the value");
	}
	...
	public  void selectDropDown(WebElement element, int index) {
		...
		GetterandSetterForUtility.getTest().info("Dropdown selected based on the index");
	}
	...
	public  void selectDropDown(String visibleText, WebElement element) {
		...
		GetterandSetterForUtility.getTest().info("Dropdown selected based on the visible text");
	}
	...
	public  void swithToFrame( int index) {
		...
		GetterandSetterForUtility.getTest().info("Frame Switched Successfully based on the index");
	}
	...
	public void swithToFrame( String nameOrId) {
		...
		GetterandSetterForUtility.getTest().info("Frame Switched Successfully based on the name/id");
	}
	...
	public  void swithToFrame(WebElement element) {
		...
		GetterandSetterForUtility.getTest().info("Frame Switched Successfully based on the element address");
	}
	...
	public void swithBackToHomeWebPage() {
		...
		GetterandSetterForUtility.getTest().info("Frame Switch back to the parent web page Successfully");
	}
	...
	public void intiallizeJs() {
		...
		GetterandSetterForUtility.getTest().info("Java Script Executor Intiallization successfully");
	}
	...
	public void enterDataThroughJs( WebElement element, String data) {
		...
		GetterandSetterForUtility.getTest().info("Data entered into the element Successfully through JavaScript Executor");
	}
	...
	public void clickThroughJs( WebElement element) {
		...
		GetterandSetterForUtility.getTest().info("Element clicked Successfully through JavaScript Executor");
	}
	...
	public void navigateApplicationThroughJs(String url) {
		...
		GetterandSetterForUtility.getTest().info("Application Navigated Successfully through JavaScript Executor");
	}
	...
	public  void scroolToSpecifiedHeight(String height) {
		...
		GetterandSetterForUtility.getTest().info("WebPage Scrolled till the specified height");
	}
	...
	public void scroolToBottom() {
		...
		GetterandSetterForUtility.getTest().info("WebPage Scrolled till the end of page");
	}
	...
	public void scrollTillElement(WebElement element) {
		...
		GetterandSetterForUtility.getTest().info("WebPage Scrolled till the element visible");
	}
	...
	public String takeScreenShot(String fileName, JavaUtility jutil) throws IOException {
		...
		GetterandSetterForUtility.getTest().info("ScreenShot taken Successfully");
	...
	public void alertAccept() {
		...
		GetterandSetterForUtility.getTest().info("Accept the Alert Popup Successfully");
	}
	...
	public void alertDismiss() {
		...
		GetterandSetterForUtility.getTest().info("Dismiss the Alert Popup Successfully");
	}
	...
	public void alertsendData(String data) {
		...
		GetterandSetterForUtility.getTest().info("Send the Data to the Alert Popup Successfully");
	}
	...
	public String getalertText() {
		...
		GetterandSetterForUtility.getTest().info("Fetch the Data from the Alert Popup Successfully");
		return data;
	}
